...
- [Código fonte](/android/EletricCarApp)
...
- [Código fonte](/android/androidmaterial/)
...
- [Código fonte](/android/NavigationComponent/)

- [Refatorando Electric Car App com Navigation e View Binding](/android/EletricCarApp/)
